...
GRID_SPACING_M = 100.0   # meters; larger = fewer nodes/faster
...
FAIRWAY_MULTIPLIERS = {
    111930: 99.0,  # Very expensive (avoided)
    111938: 99.0,  # Very expensive (avoided)
    246342: 99.0,  # Very expensive (avoided)
...
MAP_FILE = ROOT / "route_weighed.html"
